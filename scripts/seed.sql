...
INSERT INTO posts (slug, title, excerpt, body, pub_date, updated_date, category, tags, author, hero_image, draft) VALUES (
  'markdown-style-guide', 'Markdown Style Guide', 'Here is a sample of some basic Markdown syntax that can be used when writing Markdown content in Astro.', 'Here is a sample of some basic Markdown syntax that can be used when writing Markdown content in Astro.
